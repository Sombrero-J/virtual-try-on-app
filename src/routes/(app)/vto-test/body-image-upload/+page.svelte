...
<div
	class="flex w-8/10 mx-auto flex-1 flex-col items-start justify-between gap-5 py-8 lg:flex-row lg:gap-40 lg:pt-20"
>
	...
	<div class="flex w-full max-w-[30rem] flex-col gap-2">
		...
		<Dialog bind:open={openQR} textButton={false} title={'Upload image from phone'} buttonText="Done">
			<Qrcode {token} />
		</Dialog>
	</div>
</div>
